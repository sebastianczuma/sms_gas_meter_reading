...
import com.sebastianczuma.odczytgazomierza.Activities.SetBankAccountNumber;
...
public class FragmentFirst extends Fragment implements PhoneNumber {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        meterReading = (EditText) mView.findViewById(R.id.meter_reading_input);
        TextView unit = (TextView) mView.findViewById(R.id.unit);
        TextView bankAccountNumberView = (TextView) mView.findViewById(R.id.bank_account_number);
        Button send = (Button) mView.findViewById(R.id.send);
        Button edit = (Button) mView.findViewById(R.id.edit);
        ImageButton scroll = (ImageButton) mView.findViewById(R.id.next_fragment);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), SetBankAccountNumber.class));
            }
        });
    ...
    private void checkData() {
        ...
        if (readingLength > 0 && readingLength <= 5) {
            ...
            if (bankAccountNumber.length() == 26) {
                ...
                userPleaseConfirm(getString(R.string.send_confirm)).show();
            }
        } else {
    ...
    private Dialog userPleaseConfirm(final String message) {
        if (MainActivity.isNextBlurRequested.equals("")) {
            ((MainActivity) getActivity()).backgroundBlur.blurBackgroundWithoutPrepare();
        }
