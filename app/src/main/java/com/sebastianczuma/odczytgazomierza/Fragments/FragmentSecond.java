package com.sebastianczuma.odczytgazomierza.Fragments;
...
import com.sebastianczuma.odczytgazomierza.Activities.HistoricalData;
import com.sebastianczuma.odczytgazomierza.Activities.MainActivity;
import com.sebastianczuma.odczytgazomierza.Animations.Animations;
import com.sebastianczuma.odczytgazomierza.NotificationReminder.ReminderEventReceiver;
...
public class FragmentSecond extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RelativeLayout notifications = (RelativeLayout) mView.findViewById(R.id.notification);
        RelativeLayout historicalData = (RelativeLayout) mView.findViewById(R.id.historical_data);
        ImageButton scroll = (ImageButton) mView.findViewById(R.id.previous_fragment);
        notificationInfo = (TextView) mView.findViewById(R.id.notifications_text);
        notificationHour = (TextView) mView.findViewById(R.id.reminder_text);
        notificationIcon = (ImageView) mView.findViewById(R.id.notifications_icon);
