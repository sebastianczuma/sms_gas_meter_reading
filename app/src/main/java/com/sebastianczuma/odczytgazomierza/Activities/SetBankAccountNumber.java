...
public class SetBankAccountNumber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_bank_account_number);
        ...
        setBankAccountNumber = (Button) findViewById(R.id.save);
        whereToFind = (Button) findViewById(R.id.where_to_find);
        newBankAccountNumber = (EditText) findViewById(R.id.bank_account_number_input);

        RelativeLayout SCREEN =
                (RelativeLayout) findViewById(R.id.activity_set_bank_account_number_relative_layout);
    ...
    private void checkAndModifyUserInput() {
        bankAccountNumber = newBankAccountNumber.getText().toString();
