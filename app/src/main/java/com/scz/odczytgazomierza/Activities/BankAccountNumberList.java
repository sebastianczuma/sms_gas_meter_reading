...
public class BankAccountNumberList extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bank_account_number_list);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(BankAccountNumberList.this, SetBankAccountNumber.class));
            }
        });
        ...
        RecyclerViewAdapter2 rcAdapter = new RecyclerViewAdapter2(getAllItemList());
